...
## Project Structure
    ...
    ├── brandsmart_example_40016  # Django project configurations
...
1. Clone this repo and `cd brandsmart_example_40016`
...
2. Clone this repo and `cd brandsmart_example_40016`
